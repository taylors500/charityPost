...
* The original package name 'com.charity.spring-boot-post-upload-tools' is invalid and this project uses 'com.charity.spring_boot_post_upload_tools' instead.
